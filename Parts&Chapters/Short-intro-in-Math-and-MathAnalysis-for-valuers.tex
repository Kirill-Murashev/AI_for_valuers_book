...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.2\textwidth]{ingria_coat-of-arms.pdf}
\end{figure}
...
\begin{figure}[ht]
	\centering % 
	\includegraphics[width=0.8\textwidth]{trigon-func-anti-derivatives.pdf}
	\caption{Графики первообразных основных тригонометрических функций}\label{fig:trigon-func-anti-derivatives}
\end{figure}
%
\begin{figure}[ht]
	\centering % 
	\includegraphics[width=0.8\textwidth]{trigon-func-integral.pdf}
...
\begin{figure}[ht]
	\centering % 
	\includegraphics[width=0.8\textwidth]{arcfunctions-derivatives.pdf}
...
\begin{figure}[ht]
	\centering % 
	\includegraphics[width=0.8\textwidth]{arcfunctions-antiderivatives.pdf}
...
\begin{figure}[ht]
	\centering % 
	\includegraphics[width=0.8\textwidth]{unit-hyperbola.pdf}
...
\end{description}
Отношение гиперболического угла к~гиперболе схоже с~отношением <<обычного>> угла к~окружности. Величина гиперболического угла равна площади соответствующего сектора гиперболы, описываемой выражением ${\textstyle xy=1}$. Данная гипербола представляет собой прямоугольную гиперболу с~большой полуосью равной~${\textstyle \sqrt{2}}$, что~аналогично величине угла, соответствующего площади кругового сектора окружности радиусом~${\textstyle \sqrt{2}}$.
%
\begin{figure}[ht]
	\centering % 
	\includegraphics[width=0.8\textwidth]{hyperbolic-angle.pdf}
	\caption{Единичная гипербола}\label{fig:hyperbolic-angle}
\end{figure}
%
Рассмотрим гиперболу ${\textstyle \{(x,\frac{1}{x}):\quad x >0\}}$, т.\,е.~одну из~ветвей гиперболы~${\textstyle xy=1}$, изображённую на~рисунке~\ref{fig:hyperbolic-angle}. Тогда
\begin{itemize}
	\item гиперболический угол в~стандартном положении "--- это~угол в~точке~\textit{(0,0)} между лучом, проходящим через начало координат и~точку~\textit{(1,1)}, а~также лучом, проходящим через начало координат, а~также некоторую точку~${\textstyle \{(x,\frac{1}{x}):\quad x >0\}}$, лежащую на~гиперболе~${\textstyle xy=1}$;
	\item величина этого угла "--- площадь соответствующего гиперболического сектора, равная значению натурального логарифма~\textit{x}.
\end{itemize}
Вследствие свойств натурального логарифма:
\begin{itemize}
	\item в~отличие от~кругового угла, гиперболический угол является неограниченным~(как~и~сам~натуральный логарифм);
	\item при~${\textstyle 0 < x < 1}$ значение гиперболического угла отрицательно, это~отражает факт направленности угла.
\end{itemize}
