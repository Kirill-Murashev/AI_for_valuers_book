...
\end{figure}
%
В~случае с~градусной мерой единицей является градус, представляющий собой~${\textstyle \dfrac{1}{360}}$ часть окружности. В~случае с~числовой мерой такой единицей является \textbf{радиан}.
\begin{description}
...
Все~тригонометрические функции непрерывно и~неограниченно дифференцируемы на~всей области определения. В~таблице~\ref{tab:trigonometric-functios-derivatives-antiderivatives} приводятся производные и~первообразные.
%
\begin{table}[ht]
...
\begin{description}
	\item[Обратные тригонометрические функции "---] математические функции, являющиеся обратными к тригонометрическим функциям. К обратным тригонометрическим функциям обычно относят шесть функций, 
\end{description}
%
\begin{table}[ht]
